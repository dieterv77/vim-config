...
"Removed @Spell from next line to make sure comments are not spell checked
...
"Added the following line to ensure that eqnref et all are recognized as latex
"commands
syn region texRefZone		matchgroup=texStatement start="\\\(page\|eq\|eqn\)ref{"	end="}\|%stopzone\>"	contains=@texRefGroup
syn region texRefZone		matchgroup=texStatement start="\\v\=ref{"		end="}\|%stopzone\>"	contains=@texRefGroup
"Added citeauthor and changed highlighting for citewhatever to be the same as
"\ref
syn match  texStatement		'\\cite\%([tp]\*\=\)\=\%(author\)\=' nextgroup=texRefOption,texCite
